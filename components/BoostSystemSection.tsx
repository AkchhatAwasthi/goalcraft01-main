...
import { BoostSystemContent } from '@/data/growth-pages/types';

interface BoostSystemSectionProps {
    content: BoostSystemContent;
}

const BoostSystemSection: React.FC<BoostSystemSectionProps> = ({ content }) => {
    return (
